      ...
      <div id="abcontainer" className="md:w-[50%]  h-fit p-[2rem] ">
        <div id="aboutsection" className=" w-full h-fit ">
          ...
          >
            ...
            className=" mt-4 font-sans md:text-xl text-justify text-sm font-medium  md:font-semibold md:py-[1rem]">
...
within machine learning and artificial intelligence. I'm always willing to learn about and experiment with new technologies. I am skilled in many programming languages and technologies, including Java, JavaScript, Python, React, Node.js, and MongoDB. I'm constantly looking for new projects to work on and possibilities to interact with other devs. I'm excited to grow as a developer, learn new things, and contribute to the tech sector.
