...
<div
          ...
          >
            ...
            <motion.h2 {...fadeInUpProps} className=" text-white text-xl md:text-2xl font-semibold">
              {clg}
            </motion.h2>
            <motion.h2 {...fadeInUpProps} className=" text-slate-400 text-base font-semibold pb-2">
              {addr}
            </motion.h2>
